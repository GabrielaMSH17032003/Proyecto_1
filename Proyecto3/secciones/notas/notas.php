...
<body>
    <header class="header">
        ...
        <div class="header-content container">
            ...
            <div class="header-txt">
                <h1><span>Parches</span>
                    Notas de version</h1>
                <p>
                    Las notas de parches son importantes para comunicar a tus jugadores más comprometidos lo que has
                    cambiado en tu juego, aunque esos cambios no sean algo que pueda importarle a la mayoría de los
                    jugadores.
                </p>

            </div>
            <div class="header-img">
                <img src="images/notas.png" alt="">
                <style>
                    .header-img {
                        margin-top: 50px;
                    }
    ...
    <main class="products container">
        ...
        <h2>Notas de las versiones</h2>

        <div class="box-container" id="lista-1">
            <div class="box">
                <img src="images/version13.24.jpg" alt="">
                <div class="product-txt">
                    <h3>Notas de la version 13.4</h3>
                    <p>Riot Riru - hace 2 semanas</p>
                </div>
            </div>

            <div class="box">
                <img src="images/version12.22.jpg" alt="">
                <div class="product-txt">
                    <h3>Notas de la version 13.3</h3>
                    <p>Riot Riru - hace 2 meses</p>
                </div>
            </div>
            <div class="box">
                <img src="images/version12.23.jpg" alt="">
                <div class="product-txt">
                    <h3>Notas de la version 13.3b</h3>
                    <p>Riot Riru - hace 4 semanas</p>
                </div>
            </div>
            <div class="box">
                <img src="images/version13.1b.jpg" alt="">
                <div class="product-txt">
                    <h3>Notas de la version 13.4</h3>
                    <p>Riot Riru - hace 3 meses</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <footer>
        <div class="ligas">
            <ul class="ul_footer">
                ...
                <li><a class="a_footer" href="http://leagueoflegends.la-surveyes2.sgizmo.com/s3/"
                        target="_blank">Ayúdanos a
                        mejorar</a></li>
                <li><a class="a_footer" href="https://status.riotgames.com/?locale=es_MX&region=lan"
                        target="_blank">Estado
                        de servicio</a></li>
                <li><a class="a_footer" href="https://support.riotgames.com/hc/es-419" target="_blank">Asistencia</a>
                </li>
                <li><a class="a_footer" href="https://riotgames.sng.link/Dnyzj/csgh" target="_blank">Descarga la
                        aplicación
                        Riot Mobile</a></li>
            </ul>
        </div>
        ...
        <div class="legal">
            <ul class="ul_footer">
                <li><a class="a_footer" href="https://www.riotgames.com/es-419/privacy-notice-LATAM"
                        target="_blank">AVISO
                        DE PRIVACIDAD</a></li>
